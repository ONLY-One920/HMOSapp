...
def create_app():
    ...
    app.config['ARK_BASE_URL'] = os.getenv('ARK_BASE_URL', 'https://ark.cn-beijing.volces.com/api/v3')
    app.config['ARK_DEFAULT_MODEL'] = os.getenv('ARK_DEFAULT_MODEL', 'doubao-seed-1-6-250615')
